...
export type FamilyInviteResponse =
  components["schemas"]["FamilyInviteResponse"];
export type FamilyInviteDetailsResponse =
  components["schemas"]["FamilyInviteDetailsResponse"];
export type CreateFamilyInviteRequest =
  components["schemas"]["CreateFamilyInviteRequest"];
export type AcceptFamilyInviteRequest =
  components["schemas"]["AcceptFamilyInviteRequest"];
...
export type CreateShoppingItemRequest =
  components["schemas"]["CreateShoppingItemRequest"];
export type WeeklyCalendarResponse =
  components["schemas"]["WeeklyCalendarResponse"];
...
export type CalendarSourceSettingsResponse =
  components["schemas"]["CalendarSourceSettingsResponse"];
export type GoogleConnectionSummary =
  components["schemas"]["GoogleConnectionSummary"];
export type UpdateCalendarSourcesRequest =
  components["schemas"]["UpdateCalendarSourcesRequest"];
export type GoogleAuthorizationUrlResponse =
  components["schemas"]["GoogleAuthorizationUrlResponse"];
export type GoogleCalendarSummary =
  components["schemas"]["GoogleCalendarSummary"];
export type GoogleCalendarListResponse =
  components["schemas"]["GoogleCalendarListResponse"];
export type UpdateGoogleCalendarSelectionRequest =
  components["schemas"]["UpdateGoogleCalendarSelectionRequest"];
export type DashboardSourcesSummary =
  components["schemas"]["DashboardSourcesSummary"];
export type DashboardGoogleSourceStatus =
  components["schemas"]["DashboardGoogleSourceStatus"];

export function register(client: ClientOptions, body: RegisterRequest) {
  return request<AuthResponse, "/api/v1/auth/register", "post">(
...
export function login(client: ClientOptions, body: LoginRequest) {
  return request<AuthResponse, "/api/v1/auth/login", "post">(
    "/api/v1/auth/login",
    "post",
    { ...client, body },
  );
...
export function getBootstrap(client: ClientOptions) {
  return request<BootstrapResponse, "/api/v1/me/bootstrap", "get">(
    "/api/v1/me/bootstrap",
    "get",
    client,
  );
...
export function getProfiles(client: ClientOptions) {
  return request<ProfileResponse[], "/api/v1/profiles", "get">(
    "/api/v1/profiles",
    "get",
    client,
  );
...
export function getFamilyInvites(client: ClientOptions) {
  return request<FamilyInviteResponse[], "/api/v1/family-invites", "get">(
...
export function createFamilyInvite(
  ...
  return request<FamilyInviteResponse, "/api/v1/family-invites", "post">(
    "/api/v1/family-invites",
    "post",
    {
      ...client,
...
export function getFamilyInvite(client: ClientOptions, token: string) {
  return request<FamilyInviteDetailsResponse, "/api/v1/invites/{token}", "get">(
...
export function acceptFamilyInvite(
  client: ClientOptions,
  token: string,
  body: AcceptFamilyInviteRequest,
) {
  return request<AuthResponse, "/api/v1/invites/{token}/accept", "post">(
...
export function deleteAccount(
  ...
  return request<unknown, "/api/v1/privacy/account/delete", "post">(
...
export function deleteFamily(client: ClientOptions, body: DeleteFamilyRequest) {
  return request<unknown, "/api/v1/privacy/family/delete", "post">(
...
export function createProfile(
  ...
  return request<ProfileResponse, "/api/v1/profiles", "post">(
    "/api/v1/profiles",
    "post",
    { ...client, body },
  );
...
export function updateProfile(
  ...
  return request<ProfileResponse, "/api/v1/profiles/{profileId}", "put">(
...
export function getShoppingItems(client: ClientOptions) {
  return request<ShoppingItemResponse[], "/api/v1/shopping", "get">(
    "/api/v1/shopping",
    "get",
    client,
  );
...
export function createShoppingItem(
  ...
  return request<ShoppingItemResponse, "/api/v1/shopping", "post">(
    "/api/v1/shopping",
    "post",
    { ...client, body },
  );
...
export function updateShoppingItem(
  ...
  return request<ShoppingItemResponse, "/api/v1/shopping/{itemId}", "put">(
...
export function getCalendarWeek(client: ClientOptions, start: string) {
  return request<WeeklyCalendarResponse, "/api/v1/calendar/week", "get">(
...
export function createCalendarEvent(
  ...
  return request<CalendarEventResponse, "/api/v1/calendar", "post">(
    "/api/v1/calendar",
    "post",
    { ...client, body },
  );
...
export function updateCalendarEvent(
  ...
  return request<CalendarEventResponse, "/api/v1/calendar/{eventId}", "put">(
...
export function getMealsWeek(client: ClientOptions, start: string) {
  return request<WeeklyMealsResponse, "/api/v1/meals/week", "get">(
    "/api/v1/meals/week",
    "get",
    {
      ...client,
...
export function createMealPlan(
  ...
  return request<MealPlanResponse, "/api/v1/meals", "post">(
    "/api/v1/meals",
    "post",
    { ...client, body },
  );
...
export function updateMealPlan(
  ...
  return request<MealPlanResponse, "/api/v1/meals/{mealId}", "put">(
    "/api/v1/meals/{mealId}",
    "put",
    {
      ...client,
...
export function getMealRequests(client: ClientOptions, start: string) {
  return request<MealRequestResponse[], "/api/v1/meals/requests", "get">(
...
export function createMealRequest(
  client: ClientOptions,
  body: CreateMealRequestRequest,
) {
  return request<MealRequestResponse, "/api/v1/meals/requests", "post">(
    "/api/v1/meals/requests",
    "post",
    { ...client, body },
  );
...
export function assignMealRequest(
  client: ClientOptions,
  requestId: string,
  ...
  return request<
    ...
    "put"
  >("/api/v1/meals/requests/{requestId}/assign", "put", {
    ...client,
...
export function acceptMealRequest(client: ClientOptions, requestId: string) {
  return request<
    ...
    "post"
  >("/api/v1/meals/requests/{requestId}/accept", "post", {
    ...client,
    pathParams: { requestId },
  });
}
...
export function seedDevelopmentUser(client: ClientOptions) {
  return request<DevelopmentSeedResponse, "/api/v1/dev/seed", "post">(
    "/api/v1/dev/seed",
    "post",
    client,
  );
...
export function getCalendarSources(client: ClientOptions) {
  return request<
    CalendarSourceSettingsResponse,
    "/api/v1/calendar/sources",
    "get"
  >("/api/v1/calendar/sources", "get", client);
}

export function updateCalendarSources(
  client: ClientOptions,
  body: UpdateCalendarSourcesRequest,
) {
  return request<
    CalendarSourceSettingsResponse,
    "/api/v1/calendar/sources",
    "put"
  >("/api/v1/calendar/sources", "put", { ...client, body });
}

export function startGoogleAuthorization(client: ClientOptions) {
  return request<
    GoogleAuthorizationUrlResponse,
    "/api/v1/integrations/google/authorize",
    "post"
  >("/api/v1/integrations/google/authorize", "post", client);
}

export function getGoogleCalendars(client: ClientOptions, refresh?: boolean) {
  return request<
    GoogleCalendarListResponse,
    "/api/v1/integrations/google/calendars",
    "get"
  >("/api/v1/integrations/google/calendars", "get", {
    ...client,
...
export function updateGoogleCalendarSelection(
  client: ClientOptions,
  body: UpdateGoogleCalendarSelectionRequest,
) {
  return request<
    GoogleCalendarListResponse,
    "/api/v1/integrations/google/calendars",
    "put"
  >("/api/v1/integrations/google/calendars", "put", { ...client, body });
}

export function disconnectGoogleCalendar(client: ClientOptions) {
  return request<unknown, "/api/v1/integrations/google/disconnect", "post">(
